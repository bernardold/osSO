/** @file 	common.h
 *	@brief	Header to define standard attributes, ports and functions
 *	
 *	Header to define standard attributes, ports and functions
 ...
 * as https://gcc.gnu.org/onlinedocs/gcc/Function-Attributes.html
 */
